...
public class AddRss extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new View.OnClickListener() {
			...
			intent.setData(Uri.parse("http://www.360doc.com/content/10/0530/19/1181405_30360603.shtml"));
		...
		public void onClick(View v) {
			...
			case R.id.verify_rss:
				if((rssText.getText().toString()) != null )
						//&& (rssText.getText().toString()) != "默认")
					{new  verifyRssURL().execute(rssText.getText().toString());
	...
	protected void saveRss() {
		...
		String rssName = null;
		try {
			rssName = new verifyRssURL().execute(rssAddress).get();
	...
	private class verifyRssURL extends AsyncTask<String, Void, String>{
